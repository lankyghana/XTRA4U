        ...
        <div class="prose prose-lg max-w-none">
            ...
            <div class="bg-blue-50 rounded-2xl p-8 mb-10 border border-blue-100">
                <p class="text-lg text-gray-700 leading-relaxed m-0">
                    By accessing or using <span class="font-semibold text-brand-deep-blue">Xtra4U</span>, you agree to the following terms:
                </p>
            </div>
            ...
            <div class="mb-10">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-700">You must provide accurate information when registering.</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-brand-deep-blue mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span class="text-gray-700">All services are for lawful use only.</span>
                    </li>
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-700">Any attempt to abuse, hack, or manipulate the platform will result in account suspension.</span>
                    </li>
                </ul>
            </div>

            <!-- Payments & Transactions -->
            <div class="mb-10 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8 border border-green-100">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                ...
                <ul class="space-y-3 m-0">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-700">All payments made on Xtra4U are final once services are delivered.</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-green-600 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span class="text-gray-700">Users are responsible for confirming details before completing transactions.</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="mb-10">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-purple-600 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span class="text-gray-700">Resellers and vendors must follow Xtra4U pricing and policies.</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-red-500 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                        </svg>
                        <span class="text-gray-700">Any fraudulent activity will lead to immediate termination of the account without refund.</span>
                    </li>
                </ul>
            </div>

            <!-- Service Availability -->
            <div class="mb-10 bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-8 border border-orange-100">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                    <span class="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center mr-4">
            ...
            <!-- Account Termination -->
            <div class="mb-10 bg-red-50 rounded-2xl p-8 border border-red-100">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                    <span class="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center mr-4">
