        ...
        if (! function_exists('admin_nav_paths')) {
            function admin_nav_paths(string $name): string
            {
                return match ($name) {
                    ...
                    'payment-gateways' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />'
                    ...
                    'email-settings' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />',
                    'ussd-settings' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />',
                    'ussd-plans' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />'
                        . '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 8h6" />',
                    'ussd-events' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />',
                    'external-fulfillment-settings' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-3-3v6m9 0a9 9 0 11-18 0 9 9 0 0118 0z" />',
                    ...
                    'vendor-tiers' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />',
                    'vendor-tier-promotions' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" />',
                    'vendor-tier-history' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />',
...
@php
    $navLinks = [
        ...
        [
            'key' => 'vendor-tiers',
            'label' => 'Vendor Tiers',
            'href' => route('admin.vendor-tiers.index'),
            'matches' => ['admin.vendor-tiers.*'],
        ],
        [
            'key' => 'vendor-tier-promotions',
            'label' => 'Tier Promotions',
            'href' => route('admin.vendor-tier-promotions.index'),
            'matches' => ['admin.vendor-tier-promotions.*'],
        ],
        [
            'key' => 'vendor-tier-history',
            'label' => 'Tier History',
            'href' => route('admin.vendor-tier-history.index'),
            'matches' => ['admin.vendor-tier-history.*'],
        ],
    ];
