{{--
    platform-services/ecg.blade.php

    Official XTRA4U "ECG" page — the homepage entry point, distinct from a
    vendor's own shared storefront (/store/{vendor_code}).
...
@section('title', 'ECG - Electricity Tokens - XTRA4U')
@section('description', 'Buy ECG prepaid electricity tokens instantly on XTRA4U. Secure Mobile Money payments, delivered in minutes.')
        ...
        <div class="relative max-w-6xl mx-auto px-5 py-10 sm:py-14 text-center">
            <x-storefront.reveal from="up" class="max-w-2xl mx-auto">
                ...
                <h1 class="x4-display-xl mt-4 mb-3" style="color: var(--x4-ink-strong);">
                    Pay <span style="color: var(--x4-violet);">electricity tokens</span> instantly with XTRA4U
                </h1>

                <p class="x4-body-lg mb-5" style="color: var(--x4-ink-body);">
                    Top up your ECG prepaid meter in minutes, paid for with Mobile Money.
                </p>
    ...
    <section style="background-color: var(--x4-canvas-soft); border-top: 1px solid var(--x4-hairline); padding: 72px 0;">
        <div class="max-w-6xl mx-auto px-5">
            <x-storefront.reveal class="text-center mb-12">
                ...
                <p class="x4-body-lg" style="color: var(--x4-ink-sec);">Top up your ECG prepaid meter without leaving home.</p>
            </x-storefront.reveal>
            ...
            <div class="relative grid md:grid-cols-3 gap-6">
                ...
                @foreach ([
                    ['n' => '01', 'title' => 'Choose a Package', 'body' => 'Pick the token amount that suits your meter and budget.'],
                    ['n' => '02', 'title' => 'Enter Meter Number', 'body' => 'Add the recipient number your token confirmation should reach.'],
                    ['n' => '03', 'title' => 'Get Your Token', 'body' => 'Pay with Mobile Money and receive your ECG token within minutes.'],
                ] as $i => $step)
        ...
        <div class="max-w-6xl mx-auto px-5">
            <x-storefront.reveal class="max-w-xl mb-10">
                ...
                <h2 class="x4-display-xl mt-4 mb-3" style="color: var(--x4-ink);">
                    Reliable power, <span style="color: var(--x4-violet);">zero queues.</span>
                </h2>
                <p class="x4-body-lg" style="color: var(--x4-ink-sec);">
                    Skip the vending point and top up your prepaid meter from your phone, anytime.
                </p>
            </x-storefront.reveal>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                @foreach ([
                    ['icon' => 'zap', 'title' => 'Instant Delivery', 'body' => 'Tokens are generated and delivered within minutes of payment.'],
                    ['icon' => 'shield', 'title' => 'Secure Payments', 'body' => 'Every transaction is processed through encrypted Mobile Money.'],
                    ['icon' => 'clock', 'title' => '24/7 Availability', 'body' => 'No vending-point queues — top up any time, day or night.'],
