                        ...
                        <div class="flex-1">
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    class="block w-full rounded-lg border border-gray-300 bg-white pl-10 pr-3 py-2 text-sm shadow-sm focus:border-brand-bright-blue focus:ring-brand-bright-blue"
                                />
                            </div>
                        </div>

                        <div class="flex gap-2">
                            <button type="submit" class="inline-flex items-center justify-center rounded-lg bg-brand-deep-blue px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-brand-deep-blue/90">
                                Search
                            </button>

                            @if((string) request('q') !== '')
                                <a href="{{ route('vendor.orders.index') }}" class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50">
                                    Clear
                                </a>
                            @endif
                        </div>
