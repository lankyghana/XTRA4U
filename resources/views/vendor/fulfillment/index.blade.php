...
<x-vendor-layout :vendor="$vendor" title="Order Fulfillment" subtitle="Download processing orders and mark them completed" active="fulfillment">
    ...
    <div class="space-y-6">
        ...
        @if(session('status'))
            <div class="flex items-center gap-3 bg-violet-50 border border-violet-200 text-brand-violet-deep px-4 py-3 rounded-xl">
                <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div class="bg-white border border-gray-200 rounded-xl p-5">
                <div class="flex items-start gap-3">
                    <div class="mt-0.5 w-9 h-9 rounded-lg bg-violet-50 flex items-center justify-center">
            ...
            <div class="bg-emerald-50/40 border border-emerald-100 rounded-xl p-5">
                <div class="flex items-start gap-3">
                ...
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    ...
                    <form method="GET" action="{{ route('vendor.fulfillment.index') }}" class="flex items-end gap-2">
                        <div>
                            ...
                            <select id="limit" name="limit" class="text-sm border-gray-300 rounded-lg focus:ring-brand-violet-deep focus:border-brand-violet-deep px-3 py-2 font-medium shadow-sm">
                                @php
                        ...
                        <button type="submit" class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-semibold text-white bg-brand-violet hover:bg-brand-violet-deep transition-colors">
                            Apply
                        </button>
                    </form>
                </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    @foreach($networks as $network)
                        ...
                        @endphp
                        <div class="rounded-xl border border-gray-100 bg-white p-4 shadow-sm hover:shadow-md hover:border-violet-100 transition-all">
                            ...
                            <div class="mt-4">
                                ...
                                @else
                                    <a href="{{ route('vendor.fulfillment.download', ['network' => $network, 'limit' => (int)($limit ?? 2000)]) }}"
                                       class="w-full inline-flex items-center justify-center px-3 py-2 rounded-lg text-sm font-semibold text-white bg-brand-violet hover:bg-brand-violet-deep transition-colors {{ $count === 0 ? 'opacity-50 pointer-events-none' : '' }}">
