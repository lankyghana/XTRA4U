        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                <div class="flex items-center gap-4">
                    <div class="w-11 h-11 bg-brand-violet-soft rounded-lg flex items-center justify-center shrink-0">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide truncate">Total Orders</p>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide truncate">This Month</p>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide truncate">Avg Order Value</p>
                        <p class="text-2xl font-bold text-gray-900 mt-1">GHS {{ number_format($averageOrderValue, 2) }}</p>
                        <p class="text-xs text-gray-400 mt-0.5">Per transaction</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                <div class="flex items-center gap-4">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide truncate">Completion Rate</p>
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($completionRate, 1) }}%</p>
                        <p class="text-xs text-gray-400 mt-0.5">Orders completed</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="w-48 bg-gray-200 rounded-full h-2">
                                        <div class="bg-brand-violet h-2 rounded-full" style="width: {{ $day['percentage'] }}%"></div>
                                    </div>
