...
@section('title', 'Tier Promotion Queue')

@section('content')
<x-admin-layout title="Tier Promotion Queue" subtitle="Review and approve vendor tier promotions" active="vendor-tier-promotions">
