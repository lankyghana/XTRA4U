        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-500">Narrow down logs by date range, service type, or vendor.</p>
                </div>
            ...
            <div class="p-5">
                <form method="GET" action="{{ route('admin.recipient-numbers.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 items-end">
                    ...
                    <div class="lg:col-span-4">
                        ...
                        <input id="recipient_service_type" type="text" name="service_type" value="{{ $filters['service_type'] ?? '' }}" placeholder="e.g. MTN_DATA_1GB or afa_registration" class="w-full border border-gray-300 rounded-lg text-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-deep-blue focus:border-brand-deep-blue" />
                    </div>
                    ...
                    <div class="sm:col-span-2 lg:col-span-12">
                        ...
                        <p class="mt-2 text-xs text-gray-500">Exports stream in chunks (memory-safe) and may take time on large datasets.</p>
                    </div>
                </form>
            </div>
        </div>
