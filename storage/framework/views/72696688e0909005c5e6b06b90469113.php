...
<div class="fixed bottom-6 right-6 z-50" x-data="{ showTooltip: false }">
    ...
    <a 
        ...
        class="flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20BD5A] text-white rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300"
...
<?php /**PATH C:\Users\dktakyi001\Desktop\XTRA4U\resources\views/components/whatsapp-widget.blade.php ENDPATH**/ ?>